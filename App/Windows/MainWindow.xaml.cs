...
namespace App.Windows
{
    public sealed partial class MainWindow : Window
    {
        ...
        [
            ...
            new() { Title = "Qwen API key", Details = "Configure the Qwen API key", SearchTerms = "settings preferences qwen api key credential", Destination = "SettingsPage" },
            new() { Title = "Qwen models", Details = "Choose embedding, low-cost, high-cost, and artist models", SearchTerms = "settings preferences qwen model embedding low cost high artist", Destination = "SettingsPage" },
